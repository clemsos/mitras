...
def list_of_dict_to_csv(_rows,_csv_filepath):
...
def meme_to_gephi_csv(_path,_name):
    t0=time()
    ...
    list_to_csv(["Id", "Label"],nodes,_path + '/'+_name+'_nodes.csv')
    list_to_csv(["Source","Target"],edges,_path +'/'+_name+'_edges.csv')

    print " done in %fs" % (time() - t0)

meme_to_gephi_csv(path,"吴奇隆")